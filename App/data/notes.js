...
## Regression, Classification, and Inference **Key Concepts**
...
### Gradient Descent 
If featuire space is big, OLS is too expensive (matrix cant be solved). Instead use a step-wise approach. Calcualte error of weights, then move a little.
Use random starting weights for all features. Then consider which features are causing error in the output and push them by the amount they are hurting us. This is one step. Repeating many times until minimum reached.

**Mini-batch Stochastic Gradient Descent**  — Use a subsample n for a step, then use another n without replacement for the next step. Repeat until samples N are used (N/n steps). This is one epoch. Repeat. It is more stable and faster than single batch if N is huge.

**Adam**  — Same as above, but the step direction and step size (learning rate) is adaptive based on memory of prior steps. Consider both the trend among recent steps and the level of variation to choose step direction and size.

### Model Comparison Summary

| Situation | Recommended Model |
|-----------|------------------|
| Extreme variable space and nonlinear/complex interactions | PCA |
| Simple relationships and small variable space | Regression |
| Simple relationships and large variable space | Gradient descent |
...
### Data for decisions & pipeline redesign
Data pipeline EDA
...
R. This type of contstant self review and communication is crucial. Others are often surpirsed by how collaborative my teams are. In the end, I was able to finalized two of my projects, see two other labmates take owndership of two new projects, and ensure my third project was left in good hands.
